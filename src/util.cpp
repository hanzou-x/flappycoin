...
const char * const BITCOIN_CONF_FILENAME = "flappycoin.conf";
const char * const BITCOIN_PID_FILENAME = "flappycoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Flappycoin";
#else
    // Unix
